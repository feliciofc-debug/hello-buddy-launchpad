...
DROP POLICY IF EXISTS "System can manage empresas" ON empresas;
DROP POLICY IF EXISTS "Anyone can view socios" ON socios;
DROP POLICY IF EXISTS "System can manage socios" ON socios;

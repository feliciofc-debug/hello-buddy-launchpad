...
export default function ConfigurarAssistentePJ() {
  const [loading, setLoading] = useState(false);
  const [saving, setSaving] = useState(false);
  const [nomeAssistente, setNomeAssistente] = useState("Assistente AMZ");
    ...
    <Card className="bg-card/50 backdrop-blur border-border/50">
      ...
      <CardContent className="space-y-4">
        <div className="space-y-2">
          <Label htmlFor="nome-assistente-pj">Nome do Assistente</Label>
          <Input
            id="nome-assistente-pj"

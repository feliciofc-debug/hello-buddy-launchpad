...
export default function MidiaWhatsAppTab() {
  ...
  const carregar = async () => {
    ...
    // Somente mídias oriundas do WhatsApp (tabela midias_whatsapp já é exclusiva desse fluxo)
        ...
        <div className="flex items-start gap-3">
          ...
          <div className="text-sm">
            ...
            <p className="text-muted-foreground">
              Mande <b>foto, vídeo ou áudio</b> no WhatsApp do Jarvis contando o que rolou.
      ...
      {loading ? (
        ...
        <Card className="p-12 text-center">
          ...
          <p className="text-sm text-muted-foreground mt-1">
            Mande uma foto ou vídeo no WhatsApp do Jarvis pra começar
          </p>
        </Card>
      ) : (

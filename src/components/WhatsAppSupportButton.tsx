...
// ──────────────────────────────────────────────────────────────────────────
// Botão verde direto do WhatsApp DESATIVADO em 27/04/2026.
// Motivo: número 5521995379550 reservado EXCLUSIVAMENTE para Pietro Cobrança
// (via Wuzapi). O atendimento WhatsApp do site institucional voltará quando
// o número oficial Meta WhatsApp Business Cloud API for aprovado.
// O CHAT IA do Pietro abaixo CONTINUA ATIVO.
// ──────────────────────────────────────────────────────────────────────────
...
export function WhatsAppSupportButton() {
  ...
  return (
    <>
      {/* Botão Chat com Pietro Eugênio (único botão visível) */}
      <button

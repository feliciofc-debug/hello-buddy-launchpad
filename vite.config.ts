...
export default defineConfig(({ mode }) => ({
  ...
  define: {
    // FORÇA as variáveis no bundle (evita URL antiga compilada)
    ...
    'import.meta.env.VITE_SUPABASE_PUBLISHABLE_KEY': JSON.stringify('sb_publishable_BT7lsfrAYrPII7bsH_I6WA_zmDkhorc'),
  }
}));
